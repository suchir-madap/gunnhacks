...
#             backgroundimg = Image(
#                 source="background.jpg", size_hint_x=None, width=200, size_hint_y=None, height=200)
#             layout = GridLayout(rows=4, row_force_default=True,
#                                 row_default_height=40, spacing=10, padding=40, top=-100, right=420)
#             label = Label(text='Type Zipcode Below',
#                         size_hint_x=None, width=200, font_size='20sp')
#             self.value = TextInput(text='', size_hint_x=None, width=200)
#             enter = Button(text='Enter Zipcode', on_press=self.submit,
